...
from keenholdhcContigFilter2.keenholdhcContigFilter2Impl import keenholdhcContigFilter2
from keenholdhcContigFilter2.keenholdhcContigFilter2Server import MethodContext
from keenholdhcContigFilter2.authclient import KBaseAuth as _KBaseAuth

from installed_clients.AssemblyUtilClient import AssemblyUtil
from installed_clients.WorkspaceClient import Workspace


class keenholdhcContigFilter2Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('keenholdhcContigFilter2'):
        ...
        cls.ctx.update({'token': token,
                        'user_id': user_id,
                        'provenance': [
                            {'service': 'keenholdhcContigFilter2',
        ...
        cls.serviceImpl = keenholdhcContigFilter2(cls.cfg)
    ...
    # NOTE: According to Python unittest naming rules test method names should start from 'test'. # noqa
    def test_run_keenholdhcContigFilter2_ok(self):
    ...
    def test_run_keenholdhcContigFilter2_min_len_parse(self):
