...
This sample module contains one small method that filters contigs.
    ...
    def run_keenholdhcContigFilter2(self, ctx, params):
        """
        ...
        #BEGIN run_keenholdhcContigFilter2

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_keenholdhcContigFilter2 function. Params=' + pformat(params))
        ...
        #END run_keenholdhcContigFilter2

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_keenholdhcContigFilter2 return value ' +
